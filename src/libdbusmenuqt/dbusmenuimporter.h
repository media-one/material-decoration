...
public Q_SLOTS:
	 ...
	 * Load the menu
	 *
	 * Will emit menuUpdated() when complete. This should be done before showing a menu
	 */
	void updateMenu();
...
protected:
	/**
	 * Must create a menu, may be customized to fit host appearance. Default implementation creates
	 * a simple QMenu.
	 */
...
private:
	...
	Q_PRIVATE_SLOT(d, void slotItemsPropertiesUpdated(const DBusMenuItemList &updatedList,
